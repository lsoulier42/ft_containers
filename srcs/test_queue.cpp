...
void test_queue_constructor(void) {
	...
	std::cout << "Let's see back() of the first queue : " << test_constructor1.back() << std::endl;
	std::cout << "Let's see front() of the first queue : " << test_constructor1.front() << std::endl;
	...
	std::cout << "Let's see back() of the second queue : " << test_constructor2.back() << std::endl;
	std::cout << "Let's see front() of the first queue : " << test_constructor2.front() << std::endl;
	std::cout << "Let's remove the back with pop()" << std::endl;
	test_constructor2.pop();
	std::cout << "Let's see back() of the second queue : " << test_constructor2.back() << std::endl;
	std::cout << "Let's see front() of the first queue : " << test_constructor2.front() << std::endl;
	std::cout << "Let's try the assignation operator from the second queue: " << std::endl;
	ft::queue<int> test_assignation;
	test_assignation = test_constructor2;
	std::cout << "Let's see back() of the third queue : " << test_assignation.back() << std::endl;
	std::cout << "Let's see front() of the first queue : " << test_assignation.front() << std::endl;
}
...
void test_queue_push(void) {
	...
	std::cout << "Let's see back() of the queue : " << test_push.back() << std::endl;
	std::cout << "Let's see front() of the queue : " << test_push.front() << std::endl;
...
void test_queue_pop(void) {
	...
	std::cout << "Let's see back() of the queue : " << test_pop.back() << std::endl;
	std::cout << "Let's see front() of the queue : " << test_pop.front() << std::endl;
...
void test_queue_size(void) {
	...
	std::cout << "Let's see size() of the queue : " << test_size.size();
	std::cout << " and empty() is: " << verbose_bool(test_size.empty()) << std::endl;
...
void test_queue_swap(void) {
	...
	std::cout << "Let's create a queue of double with 3.14, 42.21 :" << std::endl;
	test_swap1.push(3.14);
	std::cout << "The back() of the first queue is : " << test_swap1.back() << std::endl;
	std::cout << "The front() of the first queue is : " << test_swap1.front() << std::endl;
	test_swap1.push(42.21);
	std::cout << "The back() of the first queue is : " << test_swap1.back() << std::endl;
	std::cout << "The front() of the first queue is : " << test_swap1.front() << std::endl;
	std::cout << "The size() is : " << test_swap1.size() << std::endl;
	std::cout << "Let's create a second queue of double with 4.815162342 : " << std::endl;
	test_swap2.push(4.815162342);
	std::cout << "The back() of the second queue is : " << test_swap2.back() << std::endl;
	std::cout << "The front() of the second queue is : " << test_swap2.front() << std::endl;
...
void test_queue_comparison(void) {
	...
	std::cout << "Let's create two identical char queues with 'a', 'b', 'c', 'd' : " << std::endl;
	...
	std::cout << "back() of the first queue is: " << test_comparison1.back() << std::endl;
	std::cout << "front() of the first queue is: " << test_comparison1.front() << std::endl;
	std::cout << " and size() is : " << test_comparison1.size() << std::endl;
	std::cout << "back() of the second queue is: " << test_comparison2.back() << std::endl;
	std::cout << "front() of the first queue is: " << test_comparison2.front() << std::endl;
	...
	std::cout << std::endl << "Let's create one char queues with 'a', 'b', 'c', 'd', ";
	std::cout << "and a second queue with 'e', 'f', 'g', 'h'" << std::endl;
